...
IMAGENET_INPUT_PATH_BASE = '/home/datasets/ImageNet2012/tfrecord'

@exp_factory.register_config_factory('vggnet_imagenet')
def image_classification_imagenet() -> cfg.ExperimentConfig:
  """Image classification on imagenet with vggnet."""
      ...
      task=ImageClassificationTask(
          model=ImageClassificationModel(
              ...
              backbone=backbones.Backbone(
                  type='vggnet', resnet=backbones.ResNet(model_id=16)),
